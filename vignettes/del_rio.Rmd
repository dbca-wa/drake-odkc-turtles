...
params:
  ...
  w2_rds_filepath: 'inst/data/w2.rds'
...
Early season surveys are counted as surveys between 15 November to the end the December.
The main field trip begins after 15 Movember, but some years (e.g. 2017) show
some additional, unrelated surveys.

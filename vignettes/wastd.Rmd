...
* Open each "Update survey XXX" link to view the survey in the data curation portal.
...
* Having all candidate surveys open in the data curation portal:
  ...
  * both: save and continue editing.
  This will adopt encounters to the respective dates and re-distribute them across
  the two candidate surveys.
...
* Mark each survey as "production" again and verify that the number of encounters
  as well as the start and end dates have not shifted.

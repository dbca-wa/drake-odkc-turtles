...
# 
# 
# todo clutch_completed == successful NESTING
...
were observed. These places include rookeries and non-rookeries.
...
```{r trt_conn_hb}
trt_conn %>% 
  dplyr::filter(species == "eretmochelys-imbricats") %>%
  gt::gt(
    groupname_col=NULL,

...
the following location codes: `r w2_data$enc %>% dplyr::filter(place_code == "DADI") %>% magrittr::extract2("location_code") %>% unique()`. All but "DA" are wrong.
...
# Conclusion
All errors above need to be rectified before WAMTRAM tagging data will be complete,
consistent, and correct in WAStD.

...
loc <- fs::path("media_plant_health")
...
dl_and_save("build_Sick-Plants-0-1_1580445581", loc)
dl_and_save("build_Vesta-0-1_1598262333", loc)
dl_and_save("build_Vesta-0-2_1598430994", loc)
dl_and_save("build_Vesta-0-2_1615456046", loc)
dl_and_save("build_Vesta-GWW_1613399302", loc)
dl_and_save("build_Vesta-GWW_1611913670", loc)
